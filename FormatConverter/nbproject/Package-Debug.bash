...
OUTPUT_BASENAME=formatconverter
PACKAGE_TOP_DIR=formatconverter/
...
# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/formatconverter.tar
cd ${NBTMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/formatconverter.tar *
checkReturnCode
