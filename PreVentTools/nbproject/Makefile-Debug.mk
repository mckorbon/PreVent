...
# CC Compiler Flags
CCFLAGS=-Wno-deprecated -Og -pg -g -std=c++17 -fPIC
CXXFLAGS=-Wno-deprecated -Og -pg -g -std=c++17 -fPIC
...
${OBJECTDIR}/AttributeUtils.o: AttributeUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../Formats -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AttributeUtils.o AttributeUtils.cpp

${OBJECTDIR}/ClippingSignalSet.o: ClippingSignalSet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../Formats -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClippingSignalSet.o ClippingSignalSet.cpp

${OBJECTDIR}/H5Cat.o: H5Cat.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../Formats -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/H5Cat.o H5Cat.cpp

${OBJECTDIR}/OutputSignalData.o: OutputSignalData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../Formats -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutputSignalData.o OutputSignalData.cpp

${OBJECTDIR}/TimeParser.o: TimeParser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../Formats -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TimeParser.o TimeParser.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../Formats -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
