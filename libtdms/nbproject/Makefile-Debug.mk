...
${OBJECTDIR}/TdmsChannel.o: TdmsChannel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TdmsChannel.o TdmsChannel.cpp

${OBJECTDIR}/TdmsGroup.o: TdmsGroup.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TdmsGroup.o TdmsGroup.cpp

${OBJECTDIR}/TdmsLeadIn.o: TdmsLeadIn.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TdmsLeadIn.o TdmsLeadIn.cpp

${OBJECTDIR}/TdmsMetaData.o: TdmsMetaData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TdmsMetaData.o TdmsMetaData.cpp

${OBJECTDIR}/TdmsObject.o: TdmsObject.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TdmsObject.o TdmsObject.cpp

${OBJECTDIR}/TdmsParser.o: TdmsParser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TdmsParser.o TdmsParser.cpp
